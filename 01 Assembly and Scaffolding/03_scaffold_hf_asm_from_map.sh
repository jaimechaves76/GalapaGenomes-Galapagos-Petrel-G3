...
function set_vars {
   ...
   output_scaffolded_asm=GalPetrel_ref_scaff_v1.fa
}
...
function create_stats {
   ...
   [ ! -s $scaflens_file ] && make_scaflens $output_scaffolded_asm > $scaflens_file
}

function run_busco {
   dual_compleasm_busco.sh $output_scaffolded_asm 96
   make_scaflens $output_scaffolded_asm > $scaflens_file
}
